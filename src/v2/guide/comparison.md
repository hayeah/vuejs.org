...
Angular 2 的学习曲线则要陡峭的多。即使是有 TypeScript 的帮助，它们的 [上手教程](https://angular.io/docs/js/latest/quickstart.html) 也还是使用了 ES2015，拥有 18 个 NPM 依赖，4个文件，以及超过 3000 个英文单词来解释，而这仅仅是为了写 Hello World 程序而已。相比而言，[Vue 的 Hello World 程序](https://jsfiddle.net/chrisvfritz/50wL7mdz/) 略微简单一些，大概也就是教程里不到一页的篇幅吧。
